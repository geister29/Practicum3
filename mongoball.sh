...
importCollection "awardsShareManagers" \
  "awardId.string(),yearId.int32(),lgId.string(),playerId.string(),pointsWon.double(),pointsMax.double(),votesFirst.double()" \
...
importCollection "fielding" \
  "playerId.string(),yearId.int32(),stint.int32(),teamId.string(),lgId.string(),position.string(),games.int32(),gamesStarted.int32(),innOuts.int32(),putOuts.int32(),assists.int32(),errors.int32(),doublePlays.int32(),passedBalls.int32(),wildPitches.int32(),stolenBases.int32(),caughtStealing.int32(),zoneRating.int32()" \
  "./clones/${MONGOBALL_DB}/core/Fielding-noheader.csv"

importCollection "fieldingOF" \
  "playerId.string(),yearId.int32(),stint.int32(),gamesLf.int32(),gamesCf.int32(),gamesRf.int32()" \
...
importCollection "fieldingPost" \
  "playerId.string(),yearId.int32(),teamId.string(),lgId.string(),round.string(),position.string(),games.int32(),gamesStarted.int32(),innOuts.int32(),putOuts.int32(),assists.int32(),errors.int32(),doublePlays.int32(),triplePlays.int32(),passedBalls.int32(),stolenBases.int32(),caughtStealing.int32()" \
  "./clones/${MONGOBALL_DB}/core/FieldingPost-noheader.csv"

importCollection "hallOfFame" \
  "playerId.string(),yearId.int32(),votedBy.string(),ballots.int32(),needed.int32(),votes.int32(),inducted.string(),category.string(),needed_note.string()" \
  "./clones/${MONGOBALL_DB}/core/HallOfFame-noheader.csv"

importCollection "homeGames" \
  "yearId.int32(),lgId.string(),teamId.string(),parkId.string(),firstDate.date(2006-01-02),lastDate.date(2006-01-02),games.int32(),openings.int32(),attendance.int32()" \
  "./clones/${MONGOBALL_DB}/core/HomeGames-noheader.csv"

importCollection "managers" \
  "playerId.string(),yearId.int32(),teamId.string(),lgId.string(),inseason.int32(),games.int32(),wins.int32(),losses.int32(),rank.int32(),playerManager.string()" \
  "./clones/${MONGOBALL_DB}/core/Managers-noheader.csv"

importCollection "managersHalf" \
  "playerId.string(),yearId.int32(),teamId.string(),lgId.string(),inseason.int32(),half.int32(),games.int32(),wins.int32(),losses.int32(),rank.int32()" \
  "./clones/${MONGOBALL_DB}/core/ManagersHalf-noheader.csv"

importCollection "parks" \
  "parkId.string(),parkName.string(),parkAlias.string(),city.string(),state.string(),country.string()" \
"./clones/${MONGOBALL_DB}/core/Parks-noheader.csv"

importCollection "people" \
   "playerId.string(),birthYear.int32(),birthMonth.int32(),birthDay.int32(),birthCountry.string(),birthState.string(),birthCity.string(),deathYear.int32(),deathMonth.int32(),deathDay.int32(),deathCountry.string(),deathState.string(),deathCity.string(),nameFirst.string(),nameLast.string(),nameGiven.string(),weight.int32(),height.int32(),bats.string(),throws.string(),debut.date(2006-01-02),finalGame.date(2006-01-02),retroId.string(),bbrefId.string()" \
   "./clones/${MONGOBALL_DB}/core/People-noheader.csv"

importCollection "pitching" \
  "playerId.string(),yearId.int32(),stint.int32(),teamId.string(),lgId.string(),wins.int32(),losses.int32(),games.int32(),gamesStarted.int32(),completeGames.int32(),shutouts.int32(),saves.int32(),ipOuts.int32(),hits.int32(),earnedRuns.int32(),homeRuns.int32(),baseOnBalls.int32(),strikeouts.int32(),oppBattingAvg.double(),era.double(),intentionalWalks.int32(),wildPitches.int32(),hitByPitch.double(),balks.int32(),battersFaced.int32(),gamesFinished.int32(),runs.int32(),sacrificeHits.int32(),sacrificeFlies.int32(),groundedIntoDoublePlays.int32()" \
...
importCollection "teamsHalf" \
  "yearId.int32(),lgId.string(),teamId.string(),half.int32(),divId.string(),divWinner.string(),rank.int32(),games.int32(),wins.int32(),losses.int32()" \
